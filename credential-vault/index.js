import crypto from 'node:crypto';import {db} from '../database/db.js';import {encrypt,decrypt} from '../shared/security.js';import {err} from '../shared/errors.js';
...
export function get(name){
  ...
  if(!row)return null;
  return decrypt(row.ciphertext,row.iv,row.tag,key());
}
